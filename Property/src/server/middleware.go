...
func pingHandler (w http.ResponseWriter, req *http.Request) {
		json.NewEncoder(w).Encode(struct{ Test string }{"API version 1.0 alive!"})
	}
...
func insertOneListing(task Property) {
...
func deleteOneTask(listing1 Property, params string) {
